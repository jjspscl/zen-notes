...
**v2.2.1** — Editor robustness improvements: fixed paste handling, selection preservation, save indicator, underline support, list shortcuts, indent/outdent, improved Enter behavior, and zoom-safe checklist clicking.
