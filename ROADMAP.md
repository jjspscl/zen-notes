...
**v2.3.5** — Keyboard and sanitizer fixes: arrow keys no longer move focus out of the editor into the browser toolbar, and legacy `xmlns` attributes in stored notes no longer trigger sanitizer warnings on load.
