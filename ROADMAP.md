...
**v2.4.0** — Keyboard fixes: arrow keys move the caret inside the editor instead of moving focus to the page, with word, line-boundary, and page movement plus shift-extend selection.
